...
\item \textbf{Luminaria}: Usaremos una de las lámparas incluidas en el sistema para simular la calefacción de nuestro piso. 
...
En la figura \ref{final} podemos ver las direcciones de grupo usadas para el proyecto. En ellas podemos ver como hemos desgranado las funcionalidades por sistemas, concretamente \textbf{iluminación, climatización} y \textbf{persianas}. 
